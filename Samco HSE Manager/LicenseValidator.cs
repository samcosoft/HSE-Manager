...
namespace QLM
{
    public class LicenseValidator
    {
        ...
        public LicenseValidator(string settingsFile)
        {
            ...
            if (license.ValidateSettingsFile(settingsFile, out var errorMessage) == false)
            {
        ...
        {
            var ret = false;
            var newComputerKey = string.Empty;

            var response = string.Empty;
            if (license.PingEx (string.Empty, out response, out var serverDate) == false)
            {
